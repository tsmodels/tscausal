...
tab <- as_hux(xx, add_colnames = TRUE) %>% add_rownames(colname = "Statistic", TRUE) %>% theme_grey() %>% map_align(by_cols("left","right","right")) %>% huxtable::set_caption("Table: Causal Analysis") %>% huxtable::set_caption_pos("bottom")
